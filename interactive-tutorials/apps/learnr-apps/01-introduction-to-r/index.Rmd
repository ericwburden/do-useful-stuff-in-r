...
```{r exercise_five, exercise=TRUE, exercise.lines = 10, exercise.eval = T}
animal <- 'fox'
animal_sound <- switch(
  animal,
  dog = 'woof', 
...
```{r exercise_six, exercise=TRUE, exercise.lines = 20, exercise.eval = F}
numbers <- 1:1000
...
```{r exercise_six, exercise=TRUE, exercise.lines = 10, exercise.eval = F}
random_number <- 0
biggest_number <- 0
...
```{r exercise_six, exercise=TRUE, exercise.lines = 15, exercise.eval = F}
random_string <- ""
current_letter <- 1
repeat {
